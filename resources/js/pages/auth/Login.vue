                ...
                <div class="grid gap-2">
                    ...
                    <div class="relative">
                        ...
                        <button
                            ...
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none transition-colors"
                            :tabindex="-1"
                        >
                            <svg
                                v-if="!showPassword"
