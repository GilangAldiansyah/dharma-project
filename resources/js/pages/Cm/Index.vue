...
const exportCm = () => {
    ...
    const monthLabel = filterMonth.value
        ...
        : 'Semua';
    XLSX.writeFile(wb, `CM_Report_${monthLabel}_${filterYear.value}.xlsx`);
};
        ...
        <div v-if="showCloseModal && selectedReport"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-t-3xl sm:rounded-2xl w-full sm:max-w-md shadow-2xl">
                ...
                <form @submit.prevent="submitClose" class="p-4 sm:p-5 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-1.5 text-gray-700 dark:text-gray-300">Action / Kesimpulan <span class="text-gray-400 font-normal text-xs ml-1">(opsional)</span></label>
